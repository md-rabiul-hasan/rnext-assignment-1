...
import { teams } from '../utils/database';
            ...
            <div key={index} className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
              <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none">
                <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                  <img src={team.image} alt={team.name} className="h-[120px] w-[120px] rounded-full" />
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-5">
                    <a href="javascript:void(0)" className="text-dark-6 hover:text-primary">
                      <FacebookIconSvg size="18" />
                    </a>
                    <a href="javascript:void(0)" className="text-dark-6 hover:text-primary">
                      <TwitterIconSvg size="18" />
                    </a>
                    <a href="javascript:void(0)" className="text-dark-6 hover:text-primary">
                      <InstagramIconSvg size="18" />
                    </a>
                  </div>
                </div>
              </div>
